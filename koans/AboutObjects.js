describe("About Objects", function() {
  ...
  describe("'in' keyword", function() {
    ...
    it("should not have the detonator however", function() {
      ...
      expect(hasDetonator).toBe(false); // initially expected this value to be undefined; didn't understand the in keyword; see developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/in for detailed explanation of "in" keyword
    });    
  });
